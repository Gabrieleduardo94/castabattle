...
import com.castaware.castabattle.domain.PersonaliseBoard.boat;
import com.castaware.castabattle.domain.PersonaliseBoard.cruiser;
import com.castaware.castabattle.domain.PersonaliseBoard.destroyer;
...
public class Board 
{
	...
	PersonaliseBoard boardPerHumano = PersonaliseBoard.getInstance();
	...
	public CellType fire(String column,int line)
	{
		...
		if (target.isShip())
		{
			if (target.isBoat())
			{
				message = "Boat Atingido com sucesso!!";
			}
			if (target.isCruiser())
			{
				message = "Cruiser Atingido com sucesso!!";
			}
			if (target.isDestroyer())
			{
				message = "Destroyer Atingido com sucesso!!";
			}
	...
	public void initPersonaliseBoard(){
		...
		System.out.println("saiu aqui" + boardPerHumano.vetor.get(0));
